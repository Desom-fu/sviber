...
prompt to ask whether the user wants to add the chart to the project.

#### Open recent...

Show a popup form to choose a recently opened chart/project
and then open it.
...
Save the project.
If a project is currently open and the project directory path is known, simply save the project to local filesystem without any dialogue.
Otherwise, open a file dialogue to for the user to select a directly to save to as the project folder,
in which case the directly does not have to be empty but must not have the `sviber-project.json` file.
Music files, image files, and all chart files will be saved to this directory.
Put a toast message after it completes.
