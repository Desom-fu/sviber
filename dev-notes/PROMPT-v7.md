...
This additional segment is very short and is independent of the horizontal zooming of the timeline
...
or hexagon (for bg note) with the same size after the end time of the event,
