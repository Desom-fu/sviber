...
const VALUE_FLAGS = new Map([
	...
	["--avatar-weavatar", "avatarWeavatar"],
	["--width", "renderWidth"],
	["--height", "renderHeight"],
	["--fps", "renderFps"],
	["--speed", "renderSpeed"],
...
export function helpText() {
	return [
		...
		"  --avatar KIND                   avatar kind: online, upload, gravatar or weavatar",
		...
		"  --avatar-weavatar EMAIL         weavatar email used when --avatar=weavatar",
