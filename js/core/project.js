...
export function createProjectManifest({ charts, activeChart }) {
...
export function normalizeProjectManifest(source) {
	...
	if (source.format != null) assert(source.format === PROJECT_FORMAT, `${PROJECT_FILENAME} is not a Sviber project manifest.`);
	if (source.version != null) assert(source.version === PROJECT_VERSION, `Unsupported Sviber project version: ${source.version}.`);
