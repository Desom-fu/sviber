...
const CDN_ASSETS = [
	...
	"https://cdn.jsdelivr.net/npm/audio-decode@3.9.3/+esm",
	"https://cdn.jsdelivr.net/npm/audio-type@2.4.1/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-mp3@1.0.0/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-flac@1.0.0/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-opus@1.0.0/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-vorbis@1.0.0/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-aac@1.1.3/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-wav@1.1.0/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-qoa@1.0.0/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-aiff@1.1.1/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-caf@1.1.1/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-webm@1.2.1/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-amr@1.1.1/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-wma@1.1.2/+esm",
	"https://cdn.jsdelivr.net/npm/@wasm-audio-decoders/opus-ml/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-aac@1.1.3/src/aac.wasm.cjs/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-amr@1.1.1/src/amr.wasm.cjs/+esm",
	"https://cdn.jsdelivr.net/npm/@audio/decode-wma@1.1.2/src/wma.wasm.cjs/+esm",
	"https://cdn.jsdelivr.net/npm/@wasm-audio-decoders/common@9.0.7/+esm",
	"https://cdn.jsdelivr.net/npm/simple-yenc@1.0.4/+esm",
	"https://cdn.jsdelivr.net/npm/@eshaz/web-worker@1.2.2/+esm",
