...
test("v16 project manifest contains chart membership, active chart and v17 macros", () => {
...
test("v16 workflows prompt for add-to-project and document the complete behavior", async () => {
	const [lifecycle, openSave, clipboard, statusBindings, commands, help, english, chinese] = await Promise.all([
		readFile(new URL("../js/app-document-lifecycle.js", import.meta.url), "utf8"),
		readFile(new URL("../js/app-open-save.js", import.meta.url), "utf8"),
		readFile(new URL("../js/app-clipboard.js", import.meta.url), "utf8"),
		readFile(new URL("../js/app-status-bindings.js", import.meta.url), "utf8"),
		readFile(new URL("../js/app-command-bindings.js", import.meta.url), "utf8"),
